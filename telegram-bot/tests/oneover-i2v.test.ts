...
assert.match(provider, /apikey: credentials\.apiKey\.trim\(\)/);
...
assert.doesNotMatch(bot, /picsart_seedance_25_720/);
assert.match(bot, /picsart_wan_v3: 5000/);
assert.match(bot, /Seedance 2\.5 I2V 480p/);
assert.doesNotMatch(bot, /seedance25_res_720/);
...
assert.match(bot, /SEEDANCE_MAX_REF_IMAGES/);
assert.match(bot, /seedance25ImageFileIds/);
assert.match(bot, /seedance25VideoFileId/);
assert.match(bot, /seedance25_inputs_done/);
assert.match(bot, /gw-v2\/workflows\/seedance\/submit/);
assert.match(bot, /resolution: '480p'/);
assert.match(bot, /generateAudio: true/);
assert.match(bot, /videoUrl/);
assert.match(bot, /PICSART_I2V_MAX_IMAGES/);
assert.match(bot, /picsart_i2v_photos_done/);
assert.match(bot, /picsartI2vImageUrls/);
...
assert.match(bot, /seedance25ImageFileIds: undefined/);
assert.match(bot, /seedance25VideoFileId: undefined/);
