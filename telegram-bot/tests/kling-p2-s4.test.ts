...
const secondaryModelMatches = source.match(/model:\s*'kling-motion-26-pro--secondary'/g) ?? [];
assert.equal(secondaryModelMatches.length, 2, 'P2 and P3 must both use the HAR-verified secondary model');
