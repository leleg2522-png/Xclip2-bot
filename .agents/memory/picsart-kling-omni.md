...
Never resubmit an accepted paid job after an authentication failure. Do not add
video-reference payload fields until a real submitted HAR captures their names.