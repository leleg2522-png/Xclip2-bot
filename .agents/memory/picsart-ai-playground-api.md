...
- GPT highest-res sizes are Picsart-custom, NOT DALL-E presets: 9:16 = `1024x1824` (verified in HAR), 1:1 = `1024x1024`; 16:9 mirrored as `1824x1024`. **Why:** code-review guessed `1024x1792`/`1792x1024` from generic OpenAI knowledge — wrong; the live web app sends 1824. Trust the HAR, not generic OpenAI docs.
